...
export function buildSystemPrompt(
  ...
  const sections: string[] = [
    ...
    'WhatsApp tiene su propio sistema de formato. Seguí estas reglas siempre:',
    '- Negrita: *texto* (un asterisco a cada lado). NUNCA uses **texto** (dos asteriscos) ni ningún otro Markdown estándar.',
    '- Nunca uses ## para títulos, ni _texto_ para cursiva, ni ninguna otra sintaxis Markdown.',
    '- Para listas, usá el punto medio · o saltos de línea limpios. NUNCA uses guiones (-) como viñetas.',
    '- Ejemplo correcto: "· *Corte clásico*: S/ 25"',
    '- Ejemplo incorrecto: "- **Corte clásico**: S/ 25"',
    '',
