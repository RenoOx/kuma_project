...
function buildStaticBody(
  ...
  return [
    ...
    '    c. Llamá request_image con purpose "payment" y esperá.',
    ...
    '  Solo cuando tengas servicio + horario + nombre + captura del pago (si aplicaba), llamá book_appointment.',
    '  Después contale al cliente que su solicitud quedó enviada al encargado.',
    '',
    'PRIORIDAD: primero el pago, después la solicitud. Cuando el negocio pide adelanto, NUNCA llames book_appointment antes de recibir la captura.',
